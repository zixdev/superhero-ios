...
final class BuildSettings: NSObject {
    ...
    static var serverConfigDefaultHomeserverUrlString: String {
        MDMSettings.serverConfigDefaultHomeserverUrlString ?? "https://superhero.com"
    }
    ...
    static var serverConfigSygnalAPIUrlString: String {
        MDMSettings.serverConfigSygnalAPIUrlString ?? "https://superhero.com/_matrix/push/v1/notify"
    }
